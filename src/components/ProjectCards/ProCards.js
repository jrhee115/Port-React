            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    <ul className="cards__items">
                        <CardItem 
                        src= {ProjectOne}
                        text1="This was my first project created with my group,
                        ...
                        <CardItem 
                        src= {ProjectTwo}
                        text1="Welcome to the Social Underground, a place where you can 
                        ...
                        <CardItem 
                        src= {ProjectThree}
                        text1="As a user, I want to be able to view create and track daily workouts. 
